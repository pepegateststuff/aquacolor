...
local Library = {
    ...
    Scheme = {
        ...
        AccentColor = Color3.fromRGB(79, 248, 255),
...
local ObsidianImageManager = {
    Assets = {
        TransparencyTexture = {
            ...
            Path = "aquacolor/assets/TransparencyTexture.png",
        ...
        SaturationMap = {
            RobloxId = 4155801252,
            Path = "aquacolor/assets/SaturationMap.png",
...
do
    local BaseURL = "https://raw.githubusercontent.com/pepegateststuff/aquacolor/refs/heads/main/"
    ...
    function ObsidianImageManager.DownloadAsset(AssetPath: string)
        ...
        local URLPath = AssetPath:gsub("aquacolor/", "")
    ...
    do
        ...
        if WindowInfo.Icon then
            New("ImageLabel", {
                ...
                Image = Library:GetIcon("droplet").Url
